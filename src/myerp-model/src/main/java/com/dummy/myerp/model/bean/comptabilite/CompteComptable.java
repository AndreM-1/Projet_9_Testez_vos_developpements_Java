...
public class CompteComptable {
	...
	// ==================== Constructeurs ====================
	//Correction André Monnier : Suppression des constructeurs public CompteComptable() et 
	//public CompteComptable(Integer pNumero) car le champ libelle doit tjrs être renseigné.
	/**
