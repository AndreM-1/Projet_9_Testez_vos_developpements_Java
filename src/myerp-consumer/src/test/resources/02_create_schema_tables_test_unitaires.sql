...
-- Quelques modifications ont été faites par rapport à l'auto-incrémentation qui n'est pas la même que sur PostgreSQL.
-- En effet, pas de séquence à définir sur la base de données embarquées H2.
